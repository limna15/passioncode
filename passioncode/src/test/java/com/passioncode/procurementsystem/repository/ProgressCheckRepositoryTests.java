...
//				}
	...
	public void entityToDTO() {// 이게 가져와 지는 것
		...
		ProgressCheckDTO progressCheckDTO = ProgressCheckDTO.builder().etc(forEtc(procurementPlan.getDetailPurchaseOrder().getCode()))
		  ...
		  .purchaseOrderDeadlineStatus(existMIn(procurementPlan.getDetailPurchaseOrder()))
	...
	public String existMIn(DetailPurchaseOrder dp) {//발주서 마감 상태
